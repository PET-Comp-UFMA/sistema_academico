    ...
    <header class="header" id="header">
        ...
        <div class="buttons_center" id="buttons_center">
            ...
            <div class="menuOculto" id="menuOculto">
                <a href="/administrar-escolas">Administrar Escolas</a>
                <a href="/administrar-supervisores">Administrar Supervisores</a>
                <a href="/administrar-professores">Administrar Professores</a>
                <a href="/administrar-estudantes">Administrar Alunos</a>
        ...
        <ul>
                <li class=item id=item1><a href="/administrar-escolas">Administrar Escolas</a></li>
                <li class=item id=item2><a href="/administrar-supervisores">Administrar Supervisores</a></li>
                <li class=item id=item3><a href="/administrar-professores">Administrar Professores</a></li>
                <li class=item id=item4><a href="/administrar-estudantes">Administrar Alunos</a></li>
